...
const addScreeningLog = (wid, docStat, workType, quantity )=> new Promise((resolve,reject)=>{
    const query = 'insert into nt_screening_log (wid, doc_stat, work_type, qunatity) values (?,?,?,?);'
...
const addCurationLog = (wid, esId, quality, quantity)=> new Promise((resolve,reject)=>{
    const query = 'insert into nt_curation_log (wid, es_id, quality, qunatity) values (?,?,?,?);'
