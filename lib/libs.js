    ...
    switch(type){
        case 'solr':
            ...
            if(restrict){
                ...
                newDocument["dc_dt_collect"]=listChecker(document["creationdate"])||"1970-01-01T00:00:00+00:00";
                newDocument["dc_dt_write"]=listChecker(document["lastmodified"])||"1970-01-01T00:00:00+00:00";
                newDocument["dc_url_loc"]=decodeURIComponent(document["url"])||null;
                newDocument["dc_page"]=listChecker(document["pages"])||0;
